        ...
        <div class="card">
          ...
          <div class="card-body"  style="text-align: center;">
            <span class='zoom' id='ex1'>
              <img class="zoom-img" src="{{ asset('/')}}image/product_image/{{ $data->product_image }}"  width='100%' height='100%' alt="{{ $data->product_name }}" style="max-width:325px">
            </span>
          </div>
    ...
    <div class="col-md-8">
        <div class="tabs">
          ...
          <div id="tab01" class="tab-contents">
            <h2>Description</h2>
            <p>Fetch product description from database</p>
          </div>
                    ...
                    <form action="{{ url('/') }}/product/submitRating" method="post" id="commentform" class="comment-form" novalidate="">
                      ...
                      <div style="clear: both;">
                        ...
                        <p class="comment-form-author">
                          ...
                          <p class="form-submit">
                            <input name="submit" type="submit" id="submitreview" class="btn btn-primary" value="Submit"> 
                            <input type="hidden" name="product_row_id" value="{{ $data->product_row_id }}" id="product_row_id">
